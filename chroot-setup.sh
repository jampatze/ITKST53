...
create_socket_dir /jail/banksvc 10004:10004 755
...
set_perms 10002:10002 770 /jail/zoobar/db/transfer/
set_perms 10002:10002 660 /jail/zoobar/db/transfer/transfer.db

#Asetetaan dynaamiselle palvelulle oikeus index.cgi:hin
set_perms 10002:0 700 /jail/zoobar/index.cgi

# Asetetaan autentikointipalvelulle oikeudet tietokannan autentikointitauluihin
set_perms 10003:10002 700 /jail/zoobar/db/cred
set_perms 10003:10002 600 /jail/zoobar/db/cred/cred.db

# Asetetaan pankkipalvelulle oikeuden tietokannan pankkitauluihin
set_perms 10004:10002 700 /jail/zoobar/db/bank
set_perms 10004:10002 600 /jail/zoobar/db/bank/bank.db
